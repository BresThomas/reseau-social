...
<script src="../js/message_ESI.js"></script>
 <link href="../css/message_ESI.css" rel="stylesheet" type="text/css">
<div class="error">
    ...
    <div class="error__title">' . $_SESSION['error_message'] . '</div>
    ...
    echo '
<script src="../js/message_ESI.js"></script>
 <link href="../css/message_ESI.css" rel="stylesheet" type="text/css"><div class="success">
    ...
    <div class="success__title">' . $_SESSION['success_message'] . '</div>
...
<div class="info">
    ...
    <div class="info__title">' . $_SESSION['info_message'] . '</div>
